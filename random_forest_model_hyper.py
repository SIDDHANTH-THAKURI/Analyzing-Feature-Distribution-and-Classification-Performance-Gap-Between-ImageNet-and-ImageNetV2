...
def main():
    ...
    y_true_test1, y_pred_test1 = evaluate_on_test_set(test1_file, best_model, scaler, "Test Set 1")
    y_true_test2, y_pred_test2 = evaluate_on_test_set(test2_file, best_model, scaler, "Test Set 2")
