...
def train_logistic_regression_incremental(train_file, model, scaler):
    ...
    """
    print("Training logistic regression model incrementally...")
    for chunk in load_data_in_chunks(train_file):
...
def main():
    ...
    # Use SGDClassifier with loss='log_loss' for logistic regression
    ...
    train_logistic_regression_incremental(train_file, model, scaler)
